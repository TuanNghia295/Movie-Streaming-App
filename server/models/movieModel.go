...
type Genre struct {
	GenrelID   int    `bson:"genre_id" json:"genre_id" validate:"required"`
	GenrelName string `bson:"genre_name" json:"genre_name" validate:"required,min=2, max=100"`
}
...
type Movie struct {
	...
	Genre       []Genre       `bson:"genre" json:"genre" validate:"required,dive"` // Genre: Thể loại
